...
class _CameraViewState extends State<CameraView> with WidgetsBindingObserver {
      ...
      if(detect_path==null)
        {
          return Container(
            width: width,
            height: height*0.5,
            child: Image.asset("assets/kite.jpg",fit: BoxFit.fill,),
          );
        }
      else
        {
          image=imageLib.decodeJpg(File(detect_path).readAsBytesSync());
          onLatestImageAvailable(image);
          return Container(
            width: width,
            height: height*0.5,
            child: Image.file(File(detect_path),fit: BoxFit.fill,),
          );
        }
  ...
  onLatestImageAvailable(imageLib.Image cameraImage) async {
